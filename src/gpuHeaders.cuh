 ...
 * @param strongNeighbor The strongest neighbor for every segment, or UNMATCHED for empty segments.
 * @param matches The matches (so far). Has been initialized with UNMATCHED values for each unmatched node.
 ...
 * @param matches The matches we've found so far (with UNMATCHED for unmatched nodes)
